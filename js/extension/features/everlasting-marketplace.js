...
rl.ready(() => {
  ...
  if (rl.pageIs('myWants', 'allItems')) {
    ...
    let getNextPage = (() => {
      var _ref = _asyncToGenerator(function* () {
        ...
        try {
          ...
          let response = yield fetch(url, { credentials: 'include' }),
          ...
          div.innerHTML = data;
          // Open in new tabs
          div.querySelectorAll('.item_release_link').forEach(function (a) {
            a.target = '_blank';
          });
    ...
    // Open in new tabs
    document.querySelectorAll('.item_release_link').forEach(a => {
      a.target = '_blank';
    });
